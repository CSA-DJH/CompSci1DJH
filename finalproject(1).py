...
def story():
    ...
    num2=num1.readlines()
    os.system("clear")
    print('You were a farmer until one day the evil Spartals came to your farm to collect taxes. You grabbed the nearest weapon, a '+ num2[1]+", and      fended of a group a Spartals because you had enough of their repressive ways.")
